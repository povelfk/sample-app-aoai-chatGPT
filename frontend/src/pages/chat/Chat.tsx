...
import { DismissRegular, SquareRegular, ShieldLockRegular, ErrorCircleRegular, AppsAddIn16Filled } from "@fluentui/react-icons";
...
import rv from "../../assets/rv_logo.svg";
...
const Chat = () => {
    ...
    const onViewSource = async (citation: Citation) =>  {
        if (citation.url && !citation.url.includes("blob.core")) {
            ...
            let sasUrl:string = await getBlobSasUrl(citation.url!);
                    ...
                    <div className={styles.chatContainer}>
                        {!messages || messages.length < 1 ? (
                            <Stack className={styles.chatEmptyState}>
                                ...
                                <h2 className={styles.chatEmptyStateSubtitle}>Welcome to Digge, your new chatbot</h2>
                            </Stack>
                        ) : (
                    ...
                    {messages && messages.length > 0 && isCitationPanelOpen && activeCitation && (
                        <Stack.Item className={styles.citationPanel} tabIndex={0} role="tabpanel" aria-label="Citations Panel">
                            ...
                            <div tabIndex={0}>
                                ...
                                />
                               <span title={activeCitation.url?.toString()}
                                    tabIndex={0}
                                    role="link"
