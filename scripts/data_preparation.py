...
if __name__ == "__main__": 
    ...
    # f"https://{args.form_rec_resource}.cognitiveservices.azure.com/" -> "https://westeurope.api.cognitive.microsoft.com/" 
    ...
    if args.form_rec_resource and args.form_rec_key:
        os.environ["FORM_RECOGNIZER_ENDPOINT"] = f"https://{args.form_rec_resource}.cognitiveservices.microsoft.com/" 
        os.environ["FORM_RECOGNIZER_KEY"] = args.form_rec_key
        if args.njobs==1:
            form_recognizer_client = DocumentAnalysisClient(endpoint=f"https://{args.form_rec_resource}.cognitiveservices.microsoft.com/", credential=AzureKeyCredential(args.form_rec_key))
